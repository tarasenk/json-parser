...
A JSON parser written from scratch in Rust with no external dependencies. Built as a learning project to get hands-on with Rust while implementing something non-trivial.
